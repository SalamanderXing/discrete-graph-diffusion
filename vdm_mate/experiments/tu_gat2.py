...
# )
#
tu_dataset = load_data(save_path=mate.data_dir, batch_size=80, seed=0)
...
from ..models.gat2 import GAT  # , EncoderDecoder
...
example_input = next(tu_dataset.train_loader)
gat = GAT(
    # in_node_features=example_input.nodes.shape[-1],
    # in_edge_features=1,
